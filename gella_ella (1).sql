...
-- B2:
SELECT a.appointment_id, p.patient_name, a.doctor_name
FROM Appointments a 
JOIN Patients p ON a.patient_id = p.patient_id 
WHERE a.doctor_name = 'Dr. Garcia';

-- C1:
SELECT p.patient_name, a.appointment_id, a.doctor_name
FROM Patients p 
LEFT JOIN Appointments a ON p.patient_id = a.patient_id;

-- C2:
SELECT a.appointment_id, a.doctor_name, p.patient_name
FROM Patients p 
